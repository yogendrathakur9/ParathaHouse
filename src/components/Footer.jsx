...
const Footer = () => {
  return (
    <div className="section p-10 w-100">
      <div className="grid lg:grid-cols-5 sm:grid-cols-2 gap-10 mb-5">
        <div>
            ...
            {footerSocials.map((footerSocial, index) => {
              return (
                <div className="" key={index}>
                  <a href="https://instagram.com/y_o_g_i_thakur_?igshid=YmMyMTA2M2Y=
                  ">{footerSocial}</a>
                </div>
              );
            })}
      ...
      <div className="flex flex-wrap justify-between gap-4 pb-8">
        <div className="">
          Copyright &#169; <span className="font-bold">Yogendra Thakur</span>.All
          rights deserved.
        </div>
